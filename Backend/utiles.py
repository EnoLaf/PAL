...
class Sortbooks():
    ...
    def random_filtered_book(self, list_style_filtered_books):
        ...
        print("Voici ton livre: ", list_style_filtered_books[random_int]["title"], list_style_filtered_books[random_int]["writer"])
        return chosen_book_title, chosen_book_writer, chosen_book_cover, chosen_book_style
